...
// Model output format per detection (23 values):
...
//   13-22: number class probabilities (G,1,2,3,4,5,O,Bs,Bb,negative)
class ModelDetector {
public:
...
private:
  ...
  static constexpr int NUM_NUMBERS = 10;           // G,1,2,3,4,5,O,Bs,Bb,negative
  static constexpr int NUM_OUTPUT_VALUES = NUM_KEYPOINT_VALUES + NUM_CONFIDENCE +
                                           NUM_COLORS + NUM_NUMBERS;  // 23
