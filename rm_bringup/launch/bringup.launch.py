...
def generate_launch_description():
    ...
    standard_robot_pp_ros2_node = IncludeLaunchDescription(
                ...
                launch_arguments={
                    "vision_debug": "true" if vision_debug else "false",
                }.items(),
            )
    ...
    if launch_params['video_play']: 
        ...
        parameters=[{
            ...
            'frame_id': 'usb_camera0_link',
            'image_topic': 'image_raw_omni',
            'camera_info_topic': 'camera_info_omni',
            'pixel_format': 'YUYV',
            'width': 1280,
            'height': 720,
            'fps': 60
    ...
    delay_usb_camera0_node = TimerAction(
        period=2.0,
        actions=[usb_camera0],
    )
