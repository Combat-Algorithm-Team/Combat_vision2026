...
Eigen::Matrix3d BaSolver::solveBa(const Armor &armor, const Eigen::Vector3d &t_camera_armor,
                                  ...
                                  const Eigen::Matrix3d &R_imu_camera) noexcept
{
    ...
    double armor_pitch = armor.number == "outpost" ? -FIFTTEN_DEGREE_RAD : FIFTTEN_DEGREE_RAD;
